...
|---|---|---|---|
| Public minimal | `https://tbom.yozi.systems/registries/edge-network/disclosure-profiles/1/public-minimal` | namespace-scoped observation subject; optional observed kind | names, addresses, routes, neighbors, MACs, detailed link state, conformance records |
