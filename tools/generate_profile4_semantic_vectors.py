...
def vector(vector_id: str, node: str, fields: list[dict], description: str, *, domain: str | None = None) -> dict:
    domain = domain or f"{BASE}/domain/edge-network-topology/4.0.0/node/{node}"
...
def main() -> None:
    ...
    vectors = [
        ...
        vector("tid-tunnel-invalid-utf8-bytes-set", "tunnel", common("tunnel", {"type": "bytes", "value_hex": "ff8041"}, f"{BASE}/registries/edge-network/interface-kinds/1/wireguard") + [{"tag": 130, "type": "utf-8", "value": f"{BASE}/registries/edge-network/interface-kinds/1/wireguard"}, {"tag": 131, "type": "array", "set_semantics": True, "value": [{"type": "digest", "value": d2}, {"type": "digest", "value": d1}]}, {"tag": 132, "type": "record", "value": [{"tag": 1, "type": "uint64", "value": 4}, {"tag": 2, "type": "bytes", "value_hex": "c0000208"}, {"tag": 3, "type": "utf-8", "value": "udp"}, {"tag": 4, "type": "uint64", "value": 51820}]}, {"tag": 133, "type": "null", "value": None}, {"tag": 134, "type": "record", "value": [{"tag": 1, "type": "utf-8", "value": f"{BASE}/registries/edge-network/tunnel-parameters/1/wireguard-public-key-id"}, {"tag": 2, "type": "digest", "value": d2}]}, {"tag": 135, "type": "uint64", "value": 51820}, {"tag": 136, "type": "array", "set_semantics": True, "value": [{"type": "record", "value": [{"tag": 1, "type": "utf-8", "value": f"{BASE}/registries/edge-network/tunnel-parameters/1/hop-limit"}, {"tag": 2, "type": "uint64", "value": 64}]}]}], "Tunnel node covers the one normative mapping for tags 134 through 136."),
        ...
        vector("tid-observation-interface", "interface", [{"tag": 1, "type": "utf-8", "value": "4.0.0"}, {"tag": 2, "type": "utf-8", "value": "interface"}, {"tag": 3, "type": "utf-8", "value": "root"}, {"tag": 4, "type": "utf-8", "value": "br-lan"}, {"tag": 5, "type": "utf-8", "value": "bridge"}], "Interface observation subject has one exact locator descriptor.", domain=f"{BASE}/domain/edge-network-topology/4.0.0/observation/subject"),
    ]
